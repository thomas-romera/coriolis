...
Cfg.getParamString    ( 'etesian.densificationMode'               ).setString( 'disabled' )
Cfg.getParamDouble    ( 'etesian.densificationTargetDensity'      ).setDouble( 0.9  )
Cfg.getParamDouble    ( 'etesian.densificationMaxFactor'          ).setDouble( 2.0  )
Cfg.getParamInt       ( 'etesian.densificationNbRampSteps'        ).setInt   ( 10   )
Cfg.getParamDouble    ( 'etesian.densificationTargetedStrength'   ).setDouble( 1.0  )
Cfg.getParamBool      ( 'etesian.densificationKeepThroughDetailed').setBool  ( True )
...
layout.addRule     ( 'Placer' )
layout.addTitle    ( 'Placer', 'Etesian - Densification')
layout.addParameter( 'Placer', 'etesian.densificationMode'                 , 'Densification mode'          , 0 )
layout.addParameter( 'Placer', 'etesian.densificationTargetDensity'        , 'Densification target density', 0 )
layout.addParameter( 'Placer', 'etesian.densificationMaxFactor'            , 'Densification max factor'    , 1 )
layout.addParameter( 'Placer', 'etesian.densificationNbRampSteps'          , 'Densification ramp steps'    , 1 )
layout.addParameter( 'Placer', 'etesian.densificationTargetedStrength'     , 'Densification targeted strength', 0 )
layout.addParameter( 'Placer', 'etesian.densificationKeepThroughDetailed'  , 'Densification keep through detailed', 1 )
layout.addRule     ( 'Placer' )
